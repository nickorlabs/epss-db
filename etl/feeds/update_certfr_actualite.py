...
SCRIPT_SECTION = "actualite"  # <<< CHANGE THIS FOR EACH NEW SCRIPT (alerte, cti, ioc, actualite)
...
def main():
    ...
    # Example for 'avis' was 'article.item.cert-avis'. For 'actualite' it might be 'article.item.cert-actualite', etc.
    ...
    while page_number <= max_pages_to_check:
        ...
        for article_tag in articles_on_page:
            ...
            osv_feed_name = f"certfr_{{current_script_section}}" # e.g., certfr_actualite
